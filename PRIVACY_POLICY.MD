...
Dijkstra, an open-source platform created by and for students, is committed to protecting your privacy. As an open-source project, our code is publicly available on [https://github.com/Dijkstra-Edu](https://github.com/Dijkstra-Edu), allowing community review for transparency and security. This Privacy Policy explains how we collect, use, share, and protect your personal information when you use our Services.

By using Dijkstra, you agree to this Privacy Policy and our Terms of Service.

## Information we collect

Dijkstra may collect the following types of information to provide and improve the services:
...
Dijkstra uses your information to:
...
Dijkstra does not share your personal data publicly and does not make your IDs, marks, or sensitive documents visible to the general public or other users by default.
...
Where required by applicable law, Dijkstra relies on one or more of the following legal bases to process your personal data:
...
Dijkstra uses reasonable technical and organizational measures to protect your information against unauthorized access, loss, misuse, alteration, or destruction.
...
Dijkstra keeps your personal data only for as long as necessary to:
...
When you connect or use third-party services such as LinkedIn, GitHub, job portals, or institutional systems through Dijkstra, their handling of your information is governed by their own terms and privacy policies.
...
If Dijkstra stores or processes data on servers located outside your state or country (for example, via cloud providers), your data may be transferred to jurisdictions that may have different data protection laws.
...
Dijkstra is intended for students who meet the minimum age required by applicable law to provide valid consent or enter into a contract.
...
Dijkstra may update this Privacy Policy from time to time. When changes are made:
